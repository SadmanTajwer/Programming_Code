...
cout << "2. Add item at the beginning of the list" << endl; cout << "3. Add item at any position" << endl;
...
cout << "10. Remove item at any position" << endl; cout << "11. Reverse" << endl; cout << "12. Sort" << endl;
...
cout << "You choosed add item to the end of the list" << endl; int item;
...
cout << "You choosed add item at any position" << endl; int pos, item;
...
cout << "Size of the list is: " << size() << endl; break;
...
cout << "Item at position " << pos << " is: " << get(pos) << endl; break;
...
cout << "Index of item is: " << indexOf(item) << endl; break;
...
cout << "You choosed remove item at any position" << endl; int pos;
